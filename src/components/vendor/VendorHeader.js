...
export default function VendorHeader({ user }) {
    ...
    return (
        <header className="flex items-center justify-between gap-6 py-4 px-4 rounded-xl" style={{ backgroundColor: '#F5F3F0' }}>
            {/* Page Title Badge */}
            <div className="flex items-center gap-4">
                <div className="px-6 py-2 rounded-full text-white font-semibold" style={{ backgroundColor: '#2D2A2A' }}>
                    {getPageTitle()}
                </div>
            </div>
