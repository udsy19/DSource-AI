...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="July 15, 2026" version="1.0">
      <Section title="Who we are">
        <p>
          ...
          &quot;Platform&quot;). We are the &quot;Data
          Fiduciary&quot; under India&apos;s Digital Personal Data Protection
          Act, 2023 (&quot;DPDP Act&quot;) and the &quot;data controller&quot;
          under the EU/UK General Data Protection Regulation
          (&quot;GDPR&quot;), where applicable, for the data described here.
        </p>
        <p>
          This Policy applies to <strong>all visitors</strong>, whether or not
          you create an account. Some features — including the AI analysis and
          image-generation tools and the contact form — can process your data
          even if you are not signed in.
        </p>
        <p>
          For privacy questions, requests, or grievances, contact our Grievance
          Officer (Section 13) at{" "}
      ...
      <Section number="1" title="Personal data we collect">
        <p>
          We collect only the data listed below. We do not collect your name at
          account signup, your phone number, precise location, or payment
        ...
        />
        <p>
          <strong>b. Contact form data (you provide it).</strong> First name,
          last name, email address, country, and your message, when you submit
          the Help Center contact form.
        </p>
        <p>
          <strong>c. Images and prompts you submit to AI features (you provide
          them).</strong>
        </p>
        <LegalList
          items={[
        ...
        />
        <p>
          <strong>d. Vendor catalog data (vendors provide it).</strong> Product
          listings, descriptions, image URLs, and CSV uploads submitted through
          the vendor portal. Each record is linked to the vendor&apos;s account
          identifier. Vendors should not include personal data in listings; any
          personal data embedded in listings remains covered by this Policy.
        </p>
        <p>
        ...
        <p>
          ...
          identifiers. We do not use localStorage or fingerprinting. We do not
          sell or share personal information for advertising, and we do not use
          your data for targeted advertising of any kind.
        </p>
      </Section>

      <Section number="2" title="Why we process your data (purposes and lawful bases)">
        <LegalList
          items={[
        ...
        />
        <p>
          We do not use your photos, prompts, or generated outputs to train our
          own AI models. If we ever propose to, we will ask for separate,
          specific, opt-in consent first, which you may refuse or withdraw
          without losing access to the Platform.
        </p>
      </Section>

      <Section number="3" title="AI processing — what happens to your photos and prompts">
        <Conspicuous>
        ...
        <p>
          Specifically: your uploaded image (including any embedded metadata)
          and/or your text prompt are sent to Google&apos;s Gemini models to
          validate the content, detect materials and objects, or generate
          design imagery. Google processes this data under the{" "}
          <a
          ...
          compliance. Google&apos;s handling of this data — including whether
          content may be used to improve Google&apos;s services on certain
          service tiers — is governed by Google&apos;s terms, not ours, and we
      ...
      <Section number="4" title="Who receives your data">
        ...
        <p>
          ...
          cross-context behavioral advertising, or provide it to data brokers.
        </p>
      </Section>
      ...
      <Section number="5" title="International data transfers">
        <p>
          ...
          located outside your country, including outside India. Transfers of
          personal data outside India are made in accordance with the DPDP Act
          and any restrictions notified by the Central Government. For EEA/UK
          users, transfers to our processors rely on safeguards such as
          Standard Contractual Clauses included in those processors&apos;
          data-processing agreements. Wherever your data is processed, it
      ...
      <Section number="6" title="Cookies">
        <p>
          We set only <strong>strictly necessary</strong> first-party cookies:
          Supabase authentication cookies (names beginning with{" "}
          <code>sb-</code>) that hold your session so you stay signed in. They
          are essential to providing the service and are not used for tracking
          or advertising. We set no analytics, preference, or marketing
          cookies. The only third-party cookies that can occur are set by
          YouTube if you choose to play the embedded video on our About page.
        </p>
      </Section>
      ...
      <Section number="8" title="Your rights">
        <p>
          Under the DPDP Act, you have the right to: access a summary of your
          personal data and how it has been processed; correct, complete, and
          update it; request erasure; have grievances redressed (Section 13);
          nominate another individual to exercise your rights in the event of
          death or incapacity; and withdraw consent at any time, as easily as
          you gave it. Withdrawing consent stops future processing but does not
          affect processing already carried out, and may make consent-dependent
          features (such as AI analysis) unavailable.
        </p>
        <p>
          If the GDPR applies to you, you additionally have rights of access,
          rectification, erasure, restriction, portability, and objection, and
          the right to complain to your supervisory authority. If you are a
          California resident and the CCPA applies, you have the rights to
          know, delete, correct, and opt out of sale/sharing (we do not sell or
          share), without discrimination.
        </p>
        <p>
          ...
          in-app self-service deletion; all requests are handled through this
          channel. We respond within 30 days for most requests and never later
          than the timelines required by applicable law. We may decline
          requests that are manifestly unfounded, excessive, or that we cannot
          verify.
        </p>
      </Section>
      ...
      <Section number="10" title="Security">
        <p>
          ...
          handle, including encryption in transit (TLS), encryption at rest by
          our storage providers, database row-level security, role-based
      ...
      <Section number="11" title="Personal data breaches">
        <p>
          ...
          undue delay in plain language, describing the nature of the breach,
          its likely consequences, the measures we are taking, and the steps
          you can take to protect yourself, along with a contact for
          questions. We will also notify the Data Protection Board of India
          and any other authorities as required by applicable law, including
          the DPDP Act&apos;s reporting timelines and, where the GDPR applies,
          its 72-hour authority notification requirement.
        </p>
      </Section>

      <Section number="12" title="Changes to this Policy">
        <p>
          We will post any changes on this page with an updated version number
          and date, and for material changes we will give you advance notice
          by email or an in-Platform notice. Where a change requires fresh
          consent under applicable law, we will ask for it rather than assume
      ...
      <Section number="13" title="Grievance Officer and contact">
        ...
        <p>
          ...
          days (and in any event within the timelines required by applicable
          law). If you are not satisfied with our response, you may escalate
          to the Data Protection Board of India after exhausting this process.
        </p>
        <p>
