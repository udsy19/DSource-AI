...
const AboutPage = () => {
  ...
  // Placeholder video URL - replace with actual video URL
      ...
      <div className="mt-24 sm:mt-32 md:mt-40 px-4 sm:px-8 md:px-16 lg:px-24 pb-16">
        ...
        <div className="max-w-4xl mx-auto mb-12 sm:mb-16">
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            ...
            visualization platform for Brands and designers so discovering the right
            products, comparing options, and moving from inspiration to specification
        ...
        <div className="max-w-4xl mx-auto mb-10 sm:mb-14">
          ...
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            Our mission is to simplify the way design professionals find, evaluate,
            and organize materials with practical AI. We aim to reduce the time spent
            searching across scattered sources, eliminate repetitive manual
            documentation, and help teams make confident decisions without losing
        ...
        <div className="max-w-4xl mx-auto mb-16 sm:mb-24">
          ...
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            Material sourcing often means too many tabs, unclear product details,
            inconsistent spec data, and time-consuming follow-ups. dsource.ai brings
            key steps into one workflow helping you search smarter, visualize earlier,
            and document faster.
          </p>
        </div>
      </div>
