    ...
    <div className="viz-scope min-h-screen w-full">
      <div className="mx-auto max-w-4xl px-4 pt-24 pb-16 sm:px-8 sm:pt-32 md:pt-36 md:pb-24">
          ...
          <div className="relative pt-5">
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between lg:gap-10">
              ...
              <p className="viz-serif max-w-md pb-1 text-base italic text-[var(--viz-muted)] sm:text-lg lg:text-right">
                The agreement that governs the studio, the marketplace, and the
                vendor portal.
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 flex flex-wrap gap-px overflow-hidden rounded-lg border border-[var(--viz-line)] bg-[var(--viz-line)]">
          <MetaCell label="Document">Terms of service</MetaCell>
          <MetaCell label="Version">1.0</MetaCell>
          <MetaCell label="Last updated">July 15, 2026</MetaCell>
        </div>

        {/* The terms, word for word, at reading measure */}
        <article className="max-w-3xl">
          <Section number="1" title="Acceptance of these Terms">
            <p>
              These Terms of Service (&quot;Terms&quot;) are an electronic
              record under the Information Technology Act, 2000 and a binding
              agreement between you and DSource.AI (&quot;we&quot;,
              &quot;us&quot;), governing your use of dsource.ai and its related
              tools and services (the &quot;Platform&quot;). They do not require
            ...
            <p>
              ...
              explains how we handle personal data and forms part of your
              relationship with us, though consent to data processing is
              obtained separately as required by law.
            </p>
          </Section>
          ...
          <Section number="4" title="The Platform">
            <p>
              ...
              tools, and a vendor portal for suppliers to manage product
              listings.
            </p>
            <p>
              The Platform is under active development.{" "}
              <strong>
                Features may be added, modified, degraded, suspended, or removed
              ...
              not warranted to be real, accurate, or personalized — this
              includes, without limitation, indicative pricing figures,
              availability badges, dashboard analytics, and sample export
              documents.
            </p>
          </Section>
          ...
          <Section
            number="5"
            title="AI features: Inputs, Outputs, and ownership"
          >
            <p>
              <strong>Your Inputs.</strong> You retain ownership of your Inputs.
              You grant us a non-exclusive, worldwide, royalty-free license to
              host, reproduce, process, adapt, and transmit Inputs — including
              processing them through third-party AI models — solely to operate,
              provide, secure, and improve the Platform. We do not use your
              Inputs or Outputs to train AI models without your separate opt-in
              consent.
            </p>
            <p>
              ...
              third party&apos;s intellectual-property, privacy, or other
              rights; and that any identifiable person or private property shown
              in an uploaded photo is included with the necessary permission.
            </p>
            <p>
              <strong>Outputs.</strong> As between you and us, and subject to
              your compliance with these Terms, you own the Outputs generated
              from your Inputs. You grant us a non-exclusive, worldwide,
              royalty-free license to host, reproduce, and display Outputs to
              operate the Platform, and — only if you mark a render as public or
              submit it to a public gallery — to display it publicly with
              attribution. AI-output copyright law is unsettled in many
              jurisdictions; we make no warranty that Outputs are protectable or
              non-infringing, and you bear the risk of your use, including
              commercial use, of Outputs.
            </p>
            <Conspicuous>
              Outputs are probabilistic, machine-generated visualizations. They
              may be inaccurate, incomplete, or contain artifacts, and may not
              be unique — similar or identical outputs may be generated for
              other users. Outputs are conceptual only. They are not
              architectural, engineering, structural, electrical,
              code-compliance, or professional interior-design advice, are not
              measurements or quantity estimates, and may depict configurations
              that are physically impossible or non-compliant. You are solely
              responsible for verifying Outputs with licensed professionals
              before making purchase, construction, or design decisions.
            </Conspicuous>
            <p>
              AI features are provided by third-party model providers (currently
              Google&apos;s Gemini API). Your use of AI features must also
              comply with the applicable provider&apos;s prohibited-use
              policies. AI feature availability, quality, and limits depend on
              those providers and may change or be discontinued at any time.
            </p>
          </Section>
          ...
          <Section number="6" title="Catalog, product information, and pricing">
            <p>
              ...
              importer, or agent of any listed product, we are not a party to
              any transaction between you and a supplier, and we do not verify
            ...
            />
            <p>
              Third-party product names, brand names, and trademarks appearing
              in listings belong to their respective owners, are used for
              product identification only, and do not imply any affiliation with
              or endorsement of or by DSource.AI.
            </p>
          </Section>
          ...
          <Section number="7" title="Fees and subscriptions">
            <p>
              ...
              cancellation will be as stated at the point of purchase; we will
              give at least 30 days&apos; notice of price changes for existing
              subscribers; usage described as &quot;unlimited&quot; is subject
              to fair use and technical limits; and fees for consumed AI
              generations are non-refundable except where required by law or
              expressly stated.
            </p>
          </Section>
          ...
          <Section number="9" title="Acceptable use">
            <p>
              In line with Rule 3(1)(b) of the Information Technology
              (Intermediary Guidelines and Digital Media Ethics Code) Rules,
              2021, you must not host, upload, submit, or share content that:
              belongs to another person without authorization; is defamatory,
              obscene, pornographic, paedophilic, or invasive of another&apos;s
              privacy (including bodily privacy); is harassing, or promotes
              enmity or violence; infringes any patent, trademark, copyright, or
              other proprietary right; deceives or misleads about the origin of
              a message or knowingly communicates misinformation; impersonates
              another person; contains malware or code designed to disrupt any
              system; threatens the unity, integrity, security, or sovereignty
              of India or public order; or otherwise violates any law.
            </p>
            ...
            />
            <p>
              We may remove content, restrict features, throttle usage, and
              suspend or terminate accounts on violation, on court or government
              order, or on actual knowledge of unlawful content.
            </p>
          </Section>
          ...
          <Section
            number="11"
            title="Content complaints, IP infringement, and grievance redressal"
          >
            <p>
            ...
            <p>
              ...
              location of the material, your contact details, a statement of
              your ownership or authority, and a good-faith declaration that the
              complaint is accurate. We acknowledge complaints within 24 hours
              and dispose of them within 15 days, act on court and government
              orders within the timelines required by law, and maintain a
              repeat-infringer policy under which repeat infringers&apos;
              accounts are terminated. Content removed on a copyright complaint
              may be restored if the complainant does not obtain a court order
              within the period prescribed under the Copyright Rules.
            </p>
          </Section>

          <Section number="12" title="Disclaimers and limitation of liability">
            <Conspicuous>
              The Platform, all AI Outputs, and all catalog and vendor content
              are provided &quot;as is&quot; and &quot;as available&quot;,
              without warranties of any kind, express or implied, including
              merchantability, fitness for a particular purpose, accuracy,
              non-infringement, and uninterrupted, error-free, or secure
              operation — to the maximum extent permitted by applicable law.
            </Conspicuous>
          ...
          <Section number="13" title="Indemnification">
            <p>
              ...
              related to: (a) your User Content or Inputs; (b) your use or
              commercial exploitation of Outputs; (c) your breach of these Terms
              or of applicable law; or (d) your violation of any third
              party&apos;s rights. For Vendors, this indemnity additionally
              covers, without cap: product liability, listing inaccuracy,
              intellectual-property infringement in Vendor Content, and tax,
              regulatory, and consumer-protection claims relating to your
              products or listings. We control the defense of any indemnified
              claim; you may not settle any claim without our written consent.
          ...
          <Section number="15" title="Changes to the Platform and these Terms">
            <p>
              We may update these Terms. We will post updates on this page with
              a new version number and date, and for material changes we will
              give at least 15 days&apos; advance notice by email or an
              in-Platform notice before they take effect. If you do not agree to
              a change, stop using the Platform and, if applicable, terminate
              your account before the change takes effect; continued use after
              the effective date constitutes acceptance. Material changes
              affecting vendor economics or license scope will require
              affirmative re-acceptance. We keep versioned records of these
              Terms.
            </p>
          </Section>
          ...
          <Section number="16" title="Governing law and dispute resolution">
            ...
            <p>
              ...
              we cannot resolve amicably within 30 days shall be referred to
            ...
            <p>
              ...
              protect intellectual property or prevent misuse of the Platform.
              To the extent permitted by law, disputes must be brought
              individually and not as part of a class or representative
              proceeding.
            </p>
          </Section>
          ...
          <Section number="17" title="General">
            ...
            <p>
              ...
              or via the{" "}
              <Link className={linkClasses} href="/help-center">
                Help Center
              </Link>
              .
            </p>
