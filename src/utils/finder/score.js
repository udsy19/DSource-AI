...
export const searchKeyFor = (identity) => {
  ...
  // BARE mpn — never "brand mpn". This value is an IDENTIFIER for lookup, not
  // a search phrase: aggregators resolve `WH-1000XM4` and choke on
  // `SONY WH-1000XM4` (verified against ShopSavvy — the prefixed form returns
  // an error, the bare one returns offers). Providers that want prose use
